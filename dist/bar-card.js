...
`;let wt=(()=>{let o,r,s=[bt("bar-card")],l=[],d=vt;return class extends d{static{r=this}static{const i="function"==typeof Symbol&&Symbol.metadata?Object.create(d[Symbol.metadata]??null):void 0;t(null,o={value:r},s,{kind:"class",name:r.name,metadata:i},null,l),r=o.value,i&&Object.defineProperty(r,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:i}),e(r,l)}static async getConfigElement(){return document.createElement("bar-card-editor")}static getStubConfig(){return{}}_hass;_config;_configArray=[];_stateArray=[];_animationState=[];_rowAmount=1;shouldUpdate(t){return a(this,t,!1)}setConfig(t){if(!t)throw new Error(yt("common.invalid_configuration"));this._config=i({animation:{state:"off",speed:5},color:"var(--bar-card-color, var(--primary-color))",columns:1,direction:"right",max:100,min:0,positions:{icon:"outside",indicator:"outside",name:"inside",minmax:"off",value:"inside"}},t),"horizontal"==this._config.stack&&(this._config.columns=this._config.entities.length),this._configArray=function(t){const e=[];if(t.entities){for(const n of t.entities)if("string"==typeof n){const a=i({},t);delete a.entities;const o=i(a,{entity:n});e.push(o)}else if("object"==typeof n){const a=i({},t);delete a.entities;const o=i(a,n);e.push(o)}}else e.push(t);return e}(this._config),this._rowAmount=this._configArray.length/this._config.columns}_showMoreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}render(){return this._config&&this._hass?Y`
    ...
    `:Y``}_createBarArray(){const t=[];for(let e=0;e<this._configArray.length;e++)(t.length+1)*this._config.columns==e&&t.push(this._config.columns),this._configArray.length==e+1&&t.push(this._configArray.length-t.length*this._config.columns);const e=[];for(let i=0;i<t.length;i++){const a=[];for(let e=0;e<t[i];e++){const t=i*this._config.columns+e,o=this._configArray[t],r=this._hass.states[o.entity];if(!r){a.push(Y`
          ...
          `);continue}let s;if(s=o.attribute?r.attributes[o.attribute]:r.state,o.severity&&this._computeSeverityVisibility(s,t))continue;const l=n(this._hass,o.max),d=n(this._hass,o.min);o.limit_value&&(s=Math.min(s,l),s=Math.max(s,d)),isNaN(Number(s))||(0==o.decimal?s=Number(s).toFixed(0):o.decimal&&(s=Number(s).toFixed(o.decimal)));const p=Math.round(2*this._getLineHeightPx()),u=o.height??p;let g,m,f,v="stretch",$="0px 0px 0px 13px",b="right",_="row",y="left",A="height: 100%; width: 2px;";switch(o.direction){case"right":b="right",y="left";break;case"up":$="0px",b="top",_="column-reverse",y="bottom",A="height: 2px; width: 100%;"}switch(f=this._computeSeverityIcon(s,t)?this._computeSeverityIcon(s,t):o.icon?o.icon:r.attributes.icon?r.attributes.icon:h(c(o.entity),s),o.positions.icon){case"outside":g=Y`
              <bar-card-iconbar>
            ...
            `,$="0px";break;case"off":$="0px"}const w=o.name?o.name:r.attributes.friendly_name;let x,E,S,k,C,O,j;switch(o.positions.name){case"outside":x=Y`
              <bar-card-name
                class="${o.entity_row?"name-outside":""}"
                style="${"up"==o.direction?"":o.width?`width: calc(100% - ${o.width});`:""}"
                >${w}</bar-card-name
              >
            `,$="0px";break;case"inside":E=Y`
            ...
            `;break;case"inside":j=Y`
              <bar-card-value
                ...
                >${o.complementary?l-s:s} ${S}</bar-card-value
              >
            `;break;case"off":$="0px"}let N="";s>this._stateArray[t]?(N="▲","up"==o.direction?this._animationState[t]="animation-increase-vertical":this._animationState[t]="animation-increase"):s<this._stateArray[t]?(N="▼","up"==o.direction?this._animationState[t]="animation-decrease-vertical":this._animationState[t]="animation-decrease"):this._animationState[t]=this._animationState[t],isNaN(Number(s))&&(N="");const P=this._computeBarColor(s,t);let T,U;switch(o.positions.indicator){case"outside":T=Y`
              <bar-card-indicator
            ...
            `;break;case"inside":U=Y`
              <bar-card-indicator style="--bar-color: ${P};">${N}</bar-card-indicator>
            `}const I=this._computePercent(s,t,l,d),M=this._computePercent(o.target,t,l,d);let H=I,z=this._computePercent(o.target,t,l,d);z<H&&(H=z,z=I);let R="";o.width&&(v="center",R=`width: ${o.width}`);const D=this._animationState[t];let V="right",B=100*I,L="animationbar-horizontal";"animation-increase-vertical"!=D&&"animation-decrease-vertical"!=D||(V="bottom",L="animationbar-vertical",B=100*(100-I)),a.push(Y`
          <bar-card-card
            style="flex-direction: ${_}; align-items: ${v};"
          >
            ${g} ${T} ${x}
            <bar-card-background
              style="margin: ${$}; height: ${u}${"number"==typeof u?"px":""}; ${R}"
              @click=${()=>this._showMoreInfo(o.entity)}
            >
              <bar-card-backgroundbar style="--bar-color: ${P};"></bar-card-backgroundbar>
              ${"on"===o.animation.state?Y`
                    <bar-card-animationbar
                      style="animation: ${D} ${o.animation.speed}s infinite ease-out;
                             --bar-percent: ${B}%;
                             --bar-color: ${P};
        ...
        `),s!==this._stateArray[t]&&(this._stateArray[t]=s)}e.push(a)}let i="column";(this._config.columns||this._config.stack)&&(i="row");const a=[];for(const t of e)a.push(Y`
